...
const navItems = [
    ...
    { path: "/dashboard/postjob", name: "Post a Job" },
    { path: "/dashboard/postedjobs", name: "Posted Jobs" },
    { path: "/dashboard/messages", name:"Messages"}
];
const Layout = ({ children }: LayoutProps) => {
    return (
        <section className='w-full bg-background/70 flex-row items-start justify-start'>
            <aside style={{ minHeight: "calc(100vh - 64px)" }} className='w-[25%] flex flex-col items-center px-6 py-6 bg-background/30'>
